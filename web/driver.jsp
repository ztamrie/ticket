 ...
 <li> <a href="report.jsp">Report</a></li>
  ...
  <label>
      <form action="driver.jsp" method="POST">
          <table> 
              <p style="background-color:lightgreen;border-radius:10px 10px 10px 10px;font-family:'Times New Roman', Times, serif;font: lightorange">Add The New Driver Available</p>
              <tr><td>First Name</td><td><input type="text" name="city" value="" pattern="[a-zA-Z]+"/></td></tr>
              <tr><td>Last Name</td><td><input type="text" name="bus" value="" pattern="[a-zA-Z]+" /></td></tr>
              <tr><td>Phone Number</td><td><input type="text" name="price" value="" pattern="[0-9]{10}+" /></td></tr>
      ...
      Class.forName("com.mysql.jdbc.Driver");
          ...
          PreparedStatement tripPrepare=con.prepareStatement("insert into driver(fNam,lName,phoneNumber) values('"+city+"','"+bus+"','"+price+"')");
           tripPrepare.execute();
